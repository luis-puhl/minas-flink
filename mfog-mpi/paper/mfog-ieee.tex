...
\title{[DRAFT] IoT Intrusion Detection with Distributed Novelty Detection:
...
administrators.
To address those challenges new Intrusion Detection Systems (IDS) and
architectures can be explored, especially in Fog Computing and Data Stream (DS)
areas.

Recent works explored those areas, to name a few: BigFlow 
\cite{Viegas2019}
employing Apache Flink, Apache Kafka for distributed stream processing
, CATRACA 
\cite{Lopez2018}.
