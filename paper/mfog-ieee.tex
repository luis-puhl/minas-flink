...
\section{Proposal}\label{sec:implementation}
% Proposal:
...
\cite{Song2011}.
This segment is also reduced (from 7,865,245 instances) to only examples
associated to known attack types identified by existing IDS, and attack types
with more than 10,000 instances, this removes 46,390 instances.
The resulting 
