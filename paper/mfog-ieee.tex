...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\linewidth,page=1]{figures/mfog-arch-fisica.svg.pdf}
...
\begin{figure*}[tb]
  \centerline{
    \includegraphics[width=0.5\textwidth]{experiments/revised-java.log.png}
    \includegraphics[width=0.5\textwidth]{experiments/online-nd.log.png}
  }
...
\begin{figure*}[tb]
  \centerline{
    \includegraphics[width=0.5\textwidth]{experiments/tmi-base.log.png}
    \includegraphics[width=0.5\textwidth]{experiments/tmi-n12.log.png}
  }
